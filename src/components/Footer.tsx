        ...
        <div className="mx-8 lg:mx-16">
          <div className="lg:flex justify-between lg:border-b-[1px] border-opacity-10 border-white">
            <div>
              ...
              <div className="w-full border-white border-opacity-10 border-[1px] rounded-xl flex items-center justify-between my-8">
                <input
                  type="text"
                  placeholder="Enter your email"
                  className="p-4 bg-transparent rounded-xl w-full text-secondary"
                />
